...
public class CariMK extends javax.swing.JFrame {
    ...
    public void tampildata(){
        ...
        try{
        koneksi();
        String sql = "Select * from matakuliah_2322009 order by kodeMK_2322009";
    ...
    // TODO add your handling code here:
        ...
        koneksi();
        String sql = 
                "Select * from matakuliah_2322009 where kodeMK_2322009 ='" + fdCariMK.getText() + "' "
                + "or namaMK_2322009 like '%" + fdCariMK.getText() + "%'";
        rs = cn.executeQuery(sql);
        while (rs.next()) {
        tabelnyo.addRow(new Object[]{
        rs.getString(1),
    ...
    private void tblCariMKMouseClicked1() {
        ...
        if(EntriKRS.fdKDMK != null || EntriKRS.fdMK != null || EntriKRS.fdSKS != null){
            EntriKRS.fdKDMK.setText(tblCariMK.getValueAt(row, 0).toString());
            EntriKRS.fdMK.setText(tblCariMK.getValueAt(row, 1).toString());
            EntriKRS.fdSKS.setText(tblCariMK.getValueAt(row, 2).toString());
        } else if (EntriNilai.fieldKode != null || EntriNilai.fieldMataKuliah != null || EntriNilai.fieldSKS != null) {
            EntriNilai.fieldKode.setText(tblCariMK.getValueAt(row, 0).toString());
            EntriNilai.fieldMataKuliah.setText(tblCariMK.getValueAt(row, 1).toString());
            EntriNilai.fieldSKS.setText(tblCariMK.getValueAt(row, 2).toString());
        } else if (EntriNilaiPerMataKuliah.fieldKode != null || EntriNilaiPerMataKuliah.fieldMataKuliah != null
                || EntriNilaiPerMataKuliah.fieldSKS != null) {
            EntriNilaiPerMataKuliah.fieldKode.setText(tblCariMK.getValueAt(row, 0).toString());
            EntriNilaiPerMataKuliah.fieldMataKuliah.setText(tblCariMK.getValueAt(row, 1).toString());
            EntriNilaiPerMataKuliah.fieldSKS.setText(tblCariMK.getValueAt(row, 2).toString());
        }
        this.dispose();
        }
